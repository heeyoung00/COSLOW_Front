          ...
          {filteredChallenge ? (
            <div className='full-container3'>
              ...
              <div className="fullvegetable-attend-num">
                ...
                <button className="fullvegetable-attend-button" onClick={handleChallengeApplyClick}>챌린지 참가하기</button>
              </div>
              <div className="fullvegetable-img" onClick={(e) => { e.stopPropagation(); handleSaveIconClick(challenges.id); }}>
